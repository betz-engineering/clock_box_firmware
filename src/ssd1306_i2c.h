...
volatile uint8_t ssd1306_i2c_send_buffer[64], *ssd1306_i2c_send_ptr, ssd1306_i2c_send_sz,
    ssd1306_i2c_irq_state;
...
void ssd1306_i2c_setup(void) {
    ...
    tempreg = (SystemCoreClock / (2 * SSD1306_I2C_CLKRATE)) & I2C_CKCFGR_CCR;
#else
    // fast mode over 100kHz
#ifndef SSD1306_I2C_DUTY
    // 33% duty cycle
    tempreg = (SystemCoreClock / (3 * SSD1306_I2C_CLKRATE)) & I2C_CKCFGR_CCR;
#else
    // 36% duty cycle
